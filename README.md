# quarkus-textio-bug Project

This is a reproduction project demonstrating an issue when trying to read input from console (eg with a buffered reader)
and the Quarkus dev mode.
...
You can then execute your native executable with: `./target/quarkus-termio-bug-1.0.0-SNAPSHOT-runner`
